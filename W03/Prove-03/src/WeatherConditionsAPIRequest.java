...
public class WeatherConditionsAPIRequest {
    final static String APIKEY = "REPLACE WITH YOUR API KEY";
    final static String WEATHER_API_URL = "https://api.openweathermap.org/data/2.5/weather";
    ...
    public WeatherConditionsAPIRequest(String city) throws MalformedURLException {
        this.city = city;
        this.url = new URL(WEATHER_API_URL);
    ...
    private void deserialize(){
        Gson gson = new Gson();
        weatherConditions = gson.fromJson(data, WeatherConditions.class);
    }
}
