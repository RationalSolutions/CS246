...
public class WeatherDataLoader {
    private static final String API_KEY_FILE = "G:\\Coby\\school_projects\\CS246\\W03\\Prove-03\\src\\example\\apiKey.txt";
    ...
    public WeatherConditions getWeather(String city) throws IOException {
        ...
        return gson.fromJson(results, WeatherConditions.class);
    }
    ...
    public WeatherForecast getForecast(String city) throws IOException {
        ...
        return gson.fromJson(results, WeatherForecast.class);
    }
}
